...
def saveUserDetails(request):
    ...
    # d ={'firstname':firstname,'lastname':lastname,'contactno':contactno,'username':username,'email':email,'password':password,'created_date':created_date,'modified_date':modified_date,'user_id':user_id}
    # r,s=Registration.objects.get_or_create(d)
    # print(r,s)
